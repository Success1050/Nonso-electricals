    ...
    <>
      ...
      <section className='p-10 bg-white'>
        <div className='flex flex-col justify-between items-center md:flex-row'>
          ...
          <div className='md:basis-cusBasis border-[2px] border-solid border-cusBcolor w-full cussm:mt-9'>
            ...
            <div className='max-w-full rounded-cusBradius2 p-6'>
              <form action='#' method='post'>
                ...
                <input
                  type='submit'
                  value='Submit'
                  className='block w-full text-center h-auto border-cusBtnColor bg-cusBgCol py-[16px] px-[28px] text-cuscolor font-semibold text-cusFontSize8 rounded-[8px]'
                />
              </form>
            </div>
          </div>
